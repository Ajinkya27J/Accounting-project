...
class Invoice:
    ...
    def add_comment(self,comment):
        self.comments.append(comment) # append the commet in comments list
...
if __name__ == '__main__':
    ...
    invoice.add_comment("Hello discount is 20 percentage")
    invoice.add_comment("discount and tax is calulated as per state laws")

    commets_str = invoice.get_comments()
    print(commets_str)
    print(invoice_total)
